...
# Funkcja sprawdzająca i tworząca folder ItamiiTube
...
def save_installed_versions_to_file():
    ...
    version_file_path = os.path.join(os.path.expanduser("~"), "Music", "ItamiiTube", "library_versions.txt")
        ...
        if response.status_code == 200:
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                with zipfile.ZipFile(zip_path, "r") as zip_ref:
                    extract_path = os.path.join(os.path.expanduser("~"), "Music", "ItamiiTube")
...
def remove_old_exe():
    old_exe_path = os.path.join(os.path.expanduser("~"), "Music", "ItamiiTube", "old_version_application.exe")
